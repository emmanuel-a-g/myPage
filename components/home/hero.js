...
function Hero() {
  ...
  return (
    <div className={width < breakpoint ? styles.heroFull : styles.hero} style={highContrastStatus ? {backgroundColor: "#5f5e5e"} : {backgroundColor: "#003b59"}}>
      {width < breakpoint ? null : <Aside className={styles.left} />}
      <Main className={width < breakpoint ? styles.middleFull : styles.middle} />
