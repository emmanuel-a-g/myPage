...
function Intro() {
  ...
  return (
    <div className={styles.introMe}>
      ...
      <h1 className={styles.name} style={highContrastStatus? {color: "black"} : {color: "#7DFDFE"}}>Emmanuel Garcia</h1>
      <h1 className={styles.nameTwo} style={highContrastStatus? {color: "#be0d0c"} : {color: "#00ffd5"}}>I am a fullstack web developer.</h1>
